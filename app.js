...
function checkMatchPassword(passwordInput, cfPasswordsInput) {
    if(passwordInput.value !== cfPasswordsInput.value){
        showError(cfPasswordsInput, "Mật khẩu không trùng khớp")
        return true
    }
...
form.addEventListener('submit', function(e){
   ...
   let ischeckMatchError = checkMatchPassword(password, confirmPassword)
